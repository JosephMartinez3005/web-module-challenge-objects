...
export const burger = {
  ...
  discount: function(customer){
    if(customer ==="teacher"){
      this.price = this.price - 4.50;
      return this.price;
    }else if(customer === "student"){
      this.price = this.price - 4.50;
      return this.price;
    }else if (customer === 'public'){
      this.price = this.price - 1.80;
      return this.price;
    }
  }
}
...
*/
reviews.push({name: "Joseph", rating:4.5, feedback:"Really great food!"})
console.log(reviews);
...
function getLastReview(array) {
  if(array = []){
   ...
   let review = index.name + " gave the restaurant a " + index.rating + " star review, and their feedback was: "+ index.feedback
   return review
 }
} 
